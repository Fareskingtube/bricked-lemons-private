		...
		<nav className="w-screen sticky">
			<div className="bg-background-50 flex py-2.5 px-2 items-center justify-between">
				...
				<div className="flex gap-5 mr-3">
					<div className="flex flex-1 items-center justify-between lg:w-[33vw] pr-2 pl-2.5 py-0.5 bg-background-200 rounded-xl 
					...
					<Link to="/login" className="rounded-4xl flex items-center gap-1 text-text-900">
						<AiOutlineUser className="text-3xl" /><span>Account</span>
					</Link>
