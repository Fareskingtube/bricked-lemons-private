...
const mockUpdate = jest.fn() as unknown as jest.MockedFunction<(...args: any[]) => Promise<any>>
...
const { getProducts, getProductById, createProduct, updateProductRating, updateProduct } = await import("../controllers/productControllers.js");
...
describe("Products Controller - updateProductRating", () => {
  ...
  it("should update reviewRating and reviewCount when both are valid", async () => {
    ...
    mockUpdate.mockResolvedValue({ id: "abc123", reviewRating: 9, reviewCount: 50 });
